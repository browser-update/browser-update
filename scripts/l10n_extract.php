...
exec("xgettext `ls | egrep '\\.php$' | egrep -v '(header|footer|customize|ads|update(-browser)?)\\.php'` -kT_ngettext:1,2 -kT_ -kT_gettext -L PHP --from-code=utf-8 --package-name=browser-update-site -o lang/site.pot");
