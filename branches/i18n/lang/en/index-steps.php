		<ol class="steps">
			...
			<li><div>When a user visits your site with an old browser, he will be notified by a little and subtle bar, that his browser is not up-to-date, and that it would be better to switch. (<a href="#" onclick="$buo({},true);">Test the notification bar!</a>)<!--, to see all the features of this website.--></div></li>
			<li><div>
